...
const FR = {
  ...
  webSearchUrlPlaceholder: 'http://localhost:8080',
  webSearchUrlHint: 'Vide = DuckDuckGo sans clé. Renseignée = utilisée à la place.',
  sectionAccess: 'Accès',
...
const EN: Record<Key, string> = {
  ...
  webSearchUrlPlaceholder: 'http://localhost:8080',
  webSearchUrlHint: 'Empty = DuckDuckGo with no key. Set = used instead.',
